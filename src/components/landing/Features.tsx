    ...
    <>
        ...
        <div className={styles.container}>
          <div className={styles.header}>
            ...
            <p className={styles.description}>
              Olvídate de las hojas de cálculo interminables y las llamadas sin respuesta. 
              Matri.AI hace el trabajo pesado por ti.
            </p>
          </div>
          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              ...
              <p>Nuestro algoritmo analiza tu estilo, presupuesto y fecha para recomendarte solo a los proveedores perfectos para ti.</p>
            </div>
            <div className={styles.card}>
              <div className={styles.iconWrapper}><Search size={32} /></div>
              <h3>Búsqueda Centralizada</h3>
              <p>Encuentra banquetería, fotografía, música y más en un solo lugar, con perfiles verificados y transparentes.</p>
            </div>
            <div className={styles.card}>
      ...
      <section className={styles.visualBreak}>
        <div className={styles.visualContent}>
            <h2>Celebra el Amor</h2>
            <p>"El matrimonio no es un destino, sino un viaje que comienza."</p>
        </div>
      </section>
      ...
      <section id="providers" className={`${styles.section} ${styles.altBackground}`}>
        <div className={styles.container}>
          <div className={styles.header}>
            ...
            <p className={styles.description}>
              Deja de perseguir leads que no convierten. Recibe solicitudes que realmente 
              encajan con tu servicio y presupuesto.
            </p>
          </div>
